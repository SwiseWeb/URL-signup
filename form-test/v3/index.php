<html>
            ...
            $(document).ready(function(){
                $.ajaxSetup({
                    error: function (x, status, error) {
                        if (x.status == 500 || x.status == 503) {
                            alert("Well, this is embarassing, our server seems to be having trouble with your request. \r\n \r\n Please try again at a later time!");
                        }
                        else {
    ...
    <body>
        <div class="container" style="text-shadow:5px 5px 5px rgba(0,0,0,0.5);">
            ...
            <form id="signup-form">
                ...
                <fieldset id="religious-groups">
                    ...
                    <ul>
                        ...
                        <li>
                            <label for="clds" >Church of Latter Day Saints (Mormon)</label>
                            <input type="checkbox" name="religious-groups[]" value="37" id="clds" >
                        </li>
                        <li class="website-btn"><a href="https://studentview.lds.org/home.aspx/60429" target="blank" class="btn">Website &raquo;</a></li>

                        <li>
                            <label for="cco" >Coalition for Christian Outreach</label>
                            <input type="checkbox" name="religious-groups[]" value="38" id="cco" >
                        </li>
                    ...
                    <ul class="align-right">
                        ...
                        <li >
                            <label for="lsf" >LCMS-U (University Lutheran Church, LCMS)</label>
                            <input type="checkbox" name="religious-groups[]" value="20" id="lsf" >
                        </li>
                        <li class="website-btn"><a href="http://www.ulupurdue.org/" target="blank" class="btn">Website &raquo;</a></li>
