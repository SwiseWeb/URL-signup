...
if(!empty($_POST["fname"]) && !empty($_POST["lname"]) && !empty($_POST["cemail"])){
    ...
    foreach($emails_to_send as $recipient){
    	if($recipient != ""){
	    	$mailheader = "From: noreply@campusfaith.info \r\n";
		    mail($recipient,$subject,$email_content,$mailheader, "-r $recipient");
		}
    }
	...
	echo("There was an error with your submission, please verify that all fields were filled out correctly and resubmit.");
}
?>